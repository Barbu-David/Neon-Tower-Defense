...
{
        DrawTexture(current_level->pause_menu_texture,screen_width/2-current_level->pause_menu_texture.width/2,screen_height/2-current_level->pause_menu_texture.height/2-20,WHITE);
        ...
        DrawText("Exit",20+screen_width/2-current_level->pause_menu_texture.width/2,screen_height/2-current_level->pause_menu_texture.height/2+100,gui_text_size,BLACK);
